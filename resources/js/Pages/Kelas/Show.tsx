                                        ...
                                        <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl p-8 border border-gray-200 animate-in slide-in-from-bottom-6 duration-700 delay-200">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <p className="text-sm text-purple-600 font-medium">Kategori</p>
                                                            <p className="font-bold text-gray-800">{kelas.kategori}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="flex items-center">
                                                        <div className="w-10 h-10 bg-white shadow-lg rounded-lg flex items-center justify-center mr-3 border border-orange-100">
                                                            <svg className="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4m-7 0h8m-8 0H6a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V9a2 2 0 00-2-2h-1" />
                                                            </svg>
                                                        </div>
                                                        <div>
                                                            <p className="text-sm text-orange-600 font-medium">Hari</p>
                                                            <p className="font-bold text-gray-800">{kelas.hari}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <p className="text-sm text-indigo-600 font-medium">Tanggal</p>
                                                            <p className="font-bold text-gray-800">{kelas.tanggal}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm mt-6 hover:shadow-md transition-shadow duration-300">
                                                <div className="flex justify-between items-center mb-2">
                                                    <span className="text-sm font-medium text-gray-600">Peserta Terdaftar</span>
                                                    <span className="text-sm font-bold text-gray-800">{kelas.terdaftar}/{kelas.kapasitas}</span>
                                                </div>
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">{Math.round(progressPercentage)}% terisi</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-6 animate-in slide-in-from-right-4 duration-700">
                                        ...
                                        <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200 shadow-lg">
                                            <div className="text-center">
                                                ...
                                                <p className="text-sm text-emerald-600 font-medium mb-1">Harga Kelas</p>
                                                <p className="text-3xl font-bold text-emerald-800 mb-2">GRATIS</p>
                                                <p className="text-xs text-emerald-600">100% Bebas Biaya</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                                            <div className="text-center mb-6">
                                                <h3 className="font-bold text-gray-800 text-lg mb-2">Siap Bergabung?</h3>
                                                <p className="text-gray-600 text-sm">Daftar sekarang dan mulai belajar bersama kami</p>
                                            </div>
                    ...
                    <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl border border-gray-200 animate-in zoom-in-95 duration-300">
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Daftar Kelas</h2>
                            </div>
                            <button
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                   {errors.nama && <p className="text-red-500 text-sm mt-2 flex items-center">
                               ...
                               <div>
                                   ...
                                   <textarea
                                       ...
                                       required
                                   />
                                   {errors.alamat && <p className="text-red-500 text-sm mt-2 flex items-center">
                                       <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                                       </svg>
                                       {errors.alamat}
                               ...
                               <div>
                                   ...
                                   {errors.no_telp && <p className="text-red-500 text-sm mt-2 flex items-center">
                                       <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                                       </svg>
                                       {errors.no_telp}
                                   ...
                                   <p className="text-xs text-gray-500 mt-2 flex items-center">
                                       ...
                                       Link grup WhatsApp akan dikirim ke nomor ini
                                   </p>
                               </div>
                           </div>
                               ...
                               <div className="flex items-start">
                                   ...
                                   <div className="text-sm text-amber-700">
                                      ...
                                      <ul className="space-y-1 text-xs">
                                          ...
                                          <li>• Link grup kelas akan disertakan dalam pesan</li>
