// resources/js/Components/GeminiChatBot.tsx
...
- Berikan respons lengkap dalam satu kali kirim`
    ...
    return (
        <div className={`fixed ${positionClasses[position]} z-[9999]`} style={{ zIndex: 9999 }}>
            {!isOpen ? (
                <button
                ...
                >
                    ...
                    <div className="bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 text-white p-4 flex justify-between items-center">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-sm sm:text-base">WarungPasinaon Bot</h3>
                        ...
                        <button
                            ...
                            className="hover:bg-gray-800 rounded-full p-2 transition-colors duration-200 hover:scale-110"
                        ...
                        <div className="flex space-x-3">
                            <input
                                ...
                                className="
                                    ...
                                    focus:scale-105 transition-all duration-200
